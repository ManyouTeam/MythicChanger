...
public class LocateManager {
    ...
    public LocateManager() {
        ...
        File file = new File(MythicChanger.instance.getDataFolder(), languageFileName);
        if (!file.exists()) {
            downloadLocateFile();
        }
    ...
    public void downloadLocateFile() {
        ...
        String MINECRAFT_VERSION = "1." + MythicChanger.majorVersion + "." + MythicChanger.miniorVersion;
