# 💾Saved Item (Item Manager) - Premium
...
You can use command `/mc saveitem <saveItemID> <saveItemMethod>` command to save your hold item. There are 2 methods to save item.
