...
public class TextUtil {
    ...
    public static void sendMessage(Player player, String rawText) {
        ...
        if (!rawText.contains("[") || MythicChanger.freeVersion) {
            MythicChanger.methodUtil.sendChat(player, rawText);
            return;
        }
        ...
        for (String msg : parseSimpleTag(rawText, "message")) {
            MythicChanger.methodUtil.sendChat(player, msg);
            sentAny = true;
        }
        ...
        for (TagResult tag : parseArgTag(rawText, "title")) {
            ...
            MythicChanger.methodUtil.sendTitle(
                    player,
                    data.title,
                    data.subTitle,
                    data.fadeIn,
        ...
        for (TagResult tag : parseArgTag(rawText, "bossbar")) {
            ...
            MythicChanger.methodUtil.sendBossBar(
                    player,
                    data.title,
                    data.progress,
                    data.color,
