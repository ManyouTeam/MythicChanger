...
public class DebuildItem {
    ...
    public static ConfigurationSection debuildItem(ItemStack itemStack, ConfigurationSection section) {
        ...
        if (MythicChanger.methodUtil.methodID().equals("paper") &&
            ...
            section.set("component", MythicChanger.methodUtil.serializeItemStack(itemStack));
        } else {
            ...
            if (meta.hasDisplayName()) {
                section.set("name", MythicChanger.methodUtil.getItemName(meta));
            }
            ...
            if (meta instanceof SkullMeta) {
                ...
                String textureValue = MythicChanger.methodUtil.serializeSkull(skullMeta);
