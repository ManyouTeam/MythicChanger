...
public class BuildItem {
    ...
    public static ItemStack editItemStack(Player player,
        ...
        if (componentKey != null) {
            item = MythicChanger.methodUtil.editItemStack(item, player, componentKey, -1, args);
        }
        ...
        if (!MythicChanger.freeVersion && nbtSection != null && CommonUtil.checkPluginLoad("NBTAPI")) {
