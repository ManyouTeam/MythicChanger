...
public class ResetData extends AbstractChangesRule {
    ...
    public ItemStack setChange(ObjectSingleChange singleChange) {
        Object value = singleChange.get("reset-data");
    ...
    public boolean configNotContains(ConfigurationSection section) {
        return !section.contains("reset-data");
    }
    ...
    private List<String> getDataTypes(ObjectSingleChange singleChange, Object value) {
        ...
        if (value != null) {
            result.add(singleChange.getString("reset-data"));
        }
        return result;
    }
